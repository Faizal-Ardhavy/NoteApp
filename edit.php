...
<head>
    ...
    <title>Note - <?= $dataValue["judul"] ?></title>
    ...
    <form action="update.php" method="POST">
        <div class="notes" id="app">
            ...
            <div class="notes__preview">
                <input class="notes__title" name="judul" type="text" value="<?= $dataValue["judul"] ?>" required autocomplete="off" autofocus>
                <textarea class="notes__body" name="isi" required autocomplete="off" autofocus><?= $dataValue["isi"] ?></textarea>
